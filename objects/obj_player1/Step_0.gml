...
&& !(obj_player2.state = states.punch or obj_player2.state = states.handstandjump)
{
...
//SAGE2019
//Up arrow
if ((place_meeting(x,y,obj_door) && !place_meeting(x,y,obj_doorblocked)) or place_meeting(x,y,obj_dresser) or place_meeting(x,y,obj_snick) or (place_meeting(x,y,obj_keydoor)) or (place_meeting(x,y,obj_exitgate) && global.panic = true))
&& !instance_exists(obj_uparrow) && scr_solid(x,y+1) && state = states.normal && obj_player1.spotlight = true
