...
if (obj_player.key_jump or keyboard_check_pressed(vk_enter)) && optionselected = 0
{
...
if (obj_player.key_jump or keyboard_check_pressed(vk_enter)) && optionselected = 1
{
scr_soundeffect(sfx_collecttoppin)
	selected = true
	alarm[1] = 5
}
if (obj_player.key_jump or keyboard_check_pressed(vk_enter)) && optionselected = 2
{
scr_soundeffect(sfx_collecttoppin)
	selected = true
	alarm[2] = 5
