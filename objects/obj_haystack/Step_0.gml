with (obj_peasanto)
{
if place_meeting(x+hsp,y, other) && state =states.charge && other.sprite_index != spr_haystackburning && other.sprite_index != spr_haystackburningup
...
if sprite_index = spr_haystackburning && obj_player.state != states.fireass && obj_player.state != states.knightpep &&
...
{
if state = states.fireass && other.sprite_index != spr_haystackburningup && other.sprite_index != spr_haystackburning 
{
 other.sprite_index = spr_haystackburningup
}
}