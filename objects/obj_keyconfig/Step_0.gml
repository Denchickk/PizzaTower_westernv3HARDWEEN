...
if selecting = -1
{
if player = 0 && ((obj_player1.key_right2 && obj_player1.key_right2 != obj_player1.key_left2)  or keyboard_check_pressed(vk_right)) 
player += 1

if player = 1 && ((-obj_player1.key_left2 && obj_player1.key_left2 != obj_player1.key_right2 ) or keyboard_check_pressed(vk_left)) 
player -= 1
}
...
//Go back
if (obj_player.key_jump2 or keyboard_check_pressed(vk_enter)) && selecting = -1 && key_select = -1
{
...
if key_select = 0 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1  && player = 1
{
	selecting = key_select
	global.key_upN = -1
}
...
if key_select = 1 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
	global.key_downN = -1
}
...
if key_select = 2 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
	global.key_rightN = -1
}
...
if key_select = 3 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
	global.key_leftN = -1
}
...
if key_select = 4 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
	global.key_jumpN = -1
}
...
if key_select = 5 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
	global.key_slapN = -1
}
...
if key_select = 6 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
...
if key_select = 7 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
	global.key_shootN = -1
}
...
if key_select = 8 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
	global.key_tauntN = -1
}
...
if key_select = 9 && (obj_player2.key_jump or keyboard_check_pressed(vk_enter)) && selecting = -1 && player = 1
{
	selecting = key_select
	global.key_startN = -1
}
